...
class OrderItem:
    ...
    def __init__(
        ...
        self.ground_color_id = ground_color_id
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "ground_color_id": self.ground_color_id,
            "beam_color_id": self.beam_color_id,
            "pieces_per_color": self.pieces_per_color,
            "is_active": self.is_active,
            "created_at": self.created_at,
        }
    ...
    def from_dict(cls, data: dict) -> "OrderItem":
        ...
        return cls(
            ...
            ground_color_id=data.get("ground_color_id", 0),
            beam_color_id=data.get("beam_color_id", 0),
            pieces_per_color=data.get("pieces_per_color", 0),
            is_active=data.get("is_active", True),
            created_at=data.get("created_at"),
        )
